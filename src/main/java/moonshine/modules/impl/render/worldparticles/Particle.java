...
public class Particle implements IMinecraft {
    ...
    private static final Identifier TEXTURE_CROWN = Identifier.of("moonshine", "textures/world/crown.png");
    private static final Identifier TEXTURE_CUBE_BLAST = Identifier.of("moonshine", "textures/world/cubeblast1.png");
    private static final Identifier TEXTURE_DOLLAR = Identifier.of("moonshine", "textures/world/dollar.png");
    private static final Identifier TEXTURE_HEART = Identifier.of("moonshine", "textures/world/heart.png");
    private static final Identifier TEXTURE_LIGHTNING = Identifier.of("moonshine", "textures/world/lightning.png");
    private static final Identifier TEXTURE_LINE = Identifier.of("moonshine", "textures/world/line.png");
    private static final Identifier TEXTURE_RHOMBUS = Identifier.of("moonshine", "textures/world/rhombus.png");
    private static final Identifier TEXTURE_SNOWFLAKE = Identifier.of("moonshine", "textures/world/snowflake.png");
    private static final Identifier TEXTURE_STAR = Identifier.of("moonshine", "textures/world/star.png");
    private static final Identifier TEXTURE_STAR_ALT = Identifier.of("moonshine", "textures/world/star1.png");
    private static final Identifier TEXTURE_TRIANGLE = Identifier.of("moonshine", "textures/world/triangle.png");
    private static final Identifier TEXTURE_GLOW = Identifier.of("moonshine", "textures/world/dashbloom.png");

    private static final Identifier GLOW_BLOOM = Identifier.of("moonshine", "textures/world/dashbloom.png");
    private static final Identifier GLOW_BLOOM_SAMPLE = Identifier.of("moonshine", "textures/world/dashbloomsample.png");
