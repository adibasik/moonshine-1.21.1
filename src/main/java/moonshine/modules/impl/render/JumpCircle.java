...
public class JumpCircle extends ModuleStructure implements IMinecraft {
    ...
    final Identifier circleTexture = Identifier.of("moonshine", "images/circle/circle.png");
    final Identifier glowTexture = Identifier.of("moonshine", "images/particle/glow.png");
