...
public class FontRenderer {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger("moonshine/FontRenderer");
    ...
    public void loadFont(String name, String path) {
        Identifier jsonId = Identifier.of("moonshine", "fonts/" + path + ".json");
        Identifier textureId = Identifier.of("moonshine", "fonts/" + path + ".png");
