package moonshine.util.render.font;
...
public class FontPipeline {
    ...
    private static final Identifier PIPELINE_ID = Identifier.of("moonshine", "pipeline/msdf");
    private static final Identifier SHADER_ID = Identifier.of("moonshine", "core/msdf");
