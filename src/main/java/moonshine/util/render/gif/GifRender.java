package moonshine.util.render.gif;
...
public class GifRender {
    ...
    public static void init() {
        ...
        for (int i = 1; i <= 100; i++) {
            ...
            Identifier id = Identifier.of("moonshine", "images/gifs/avatar/" + frameName + ".png");
            avatarFrames.add(id);
        }

        for (int i = 0; i <= 16; i++) {
            String frameName = String.format("frame_%02d_delay-0.05s", i);
            Identifier id = Identifier.of("moonshine", "images/gifs/back/" + frameName + ".png");
