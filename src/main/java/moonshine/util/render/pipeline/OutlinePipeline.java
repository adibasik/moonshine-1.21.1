...
public class OutlinePipeline {
    ...
    private static final Identifier PIPELINE_ID = Identifier.of("moonshine", "pipeline/outline");
    private static final Identifier VERTEX_SHADER = Identifier.of("moonshine", "core/outline");
    private static final Identifier FRAGMENT_SHADER = Identifier.of("moonshine", "core/outline");
