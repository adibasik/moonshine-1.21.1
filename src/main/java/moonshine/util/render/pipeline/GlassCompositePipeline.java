...
public class GlassCompositePipeline {
    ...
    private static final Identifier PIPELINE_ID = Identifier.of("moonshine", "pipeline/glass_composite");
    private static final Identifier VERTEX_SHADER = Identifier.of("moonshine", "core/glass_composite");
    private static final Identifier FRAGMENT_SHADER = Identifier.of("moonshine", "core/glass_composite");
