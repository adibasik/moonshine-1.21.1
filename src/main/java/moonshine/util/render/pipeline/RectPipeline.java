...
public class RectPipeline {
    ...
    private static final Identifier PIPELINE_ID = Identifier.of("moonshine", "pipeline/rect");
    private static final Identifier VERTEX_SHADER = Identifier.of("moonshine", "core/rect");
    private static final Identifier FRAGMENT_SHADER = Identifier.of("moonshine", "core/rect");
