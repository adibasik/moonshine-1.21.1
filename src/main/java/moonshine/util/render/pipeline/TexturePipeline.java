...
public class TexturePipeline {
    ...
    private static final Identifier PIPELINE_ID = Identifier.of("moonshine", "pipeline/texture");
    private static final Identifier VERTEX_SHADER = Identifier.of("moonshine", "core/texture");
    private static final Identifier FRAGMENT_SHADER = Identifier.of("moonshine", "core/texture");
