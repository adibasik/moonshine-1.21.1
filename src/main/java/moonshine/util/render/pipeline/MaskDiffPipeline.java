...
public class MaskDiffPipeline {
    ...
    private static final Identifier PIPELINE_ID = Identifier.of("moonshine", "pipeline/mask_diff");
    private static final Identifier VERTEX_SHADER = Identifier.of("moonshine", "core/mask_diff");
    private static final Identifier FRAGMENT_SHADER = Identifier.of("moonshine", "core/mask_diff");
