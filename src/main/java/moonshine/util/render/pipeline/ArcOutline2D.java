    ...
    public static void init() {
        ...
        try {
            pipeline = RenderPipeline.builder()
                    .withLocation(Identifier.of("moonshine", "core/arc_outline"))
                    .withVertexShader(Identifier.of("moonshine", "core/arc_outline_vertex"))
                    .withFragmentShader(Identifier.of("moonshine", "core/arc_outline_fragment"))
