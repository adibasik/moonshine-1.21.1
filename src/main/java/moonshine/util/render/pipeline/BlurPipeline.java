...
public class BlurPipeline {
    ...
    private static final Identifier PIPELINE_ID = Identifier.of("moonshine", "pipeline/blur");
    private static final Identifier VERTEX_SHADER = Identifier.of("moonshine", "core/blur");
    private static final Identifier FRAGMENT_SHADER = Identifier.of("moonshine", "core/blur");
