package moonshine.util.render.pipeline;
...
public class KawaseBlurPipeline {
    ...
    private static final Identifier DOWN_PIPELINE_ID = Identifier.of("moonshine", "pipeline/kawase_down");
    private static final Identifier DOWN_VERTEX_SHADER = Identifier.of("moonshine", "core/kawase_down");
    private static final Identifier DOWN_FRAGMENT_SHADER = Identifier.of("moonshine", "core/kawase_down");

    private static final Identifier UP_PIPELINE_ID = Identifier.of("moonshine", "pipeline/kawase_up");
    private static final Identifier UP_VERTEX_SHADER = Identifier.of("moonshine", "core/kawase_up");
    private static final Identifier UP_FRAGMENT_SHADER = Identifier.of("moonshine", "core/kawase_up");
