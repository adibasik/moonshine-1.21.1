    ...
    public static void init() {
        ...
        try {
            pipeline = RenderPipeline.builder()
                    .withLocation(Identifier.of("moonshine", "core/arc"))
                    .withVertexShader(Identifier.of("moonshine", "core/arc_vertex"))
                    .withFragmentShader(Identifier.of("moonshine", "core/arc_fragment"))
