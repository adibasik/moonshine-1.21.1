...
public class GlowOutlinePipeline {
    ...
    private static final Identifier PIPELINE_ID = Identifier.of("moonshine", "pipeline/glow_outline");
    private static final Identifier VERTEX_SHADER = Identifier.of("moonshine", "core/glow_outline");
    private static final Identifier FRAGMENT_SHADER = Identifier.of("moonshine", "core/glow_outline");
