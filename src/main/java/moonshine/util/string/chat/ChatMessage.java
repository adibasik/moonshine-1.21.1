...
public class ChatMessage {
    public static MutableText brandmessage() {
        return (MutableText) TextHelper.applyPredefinedGradient("Moonshine Client", "black_light_purple", true);
    }
    ...
    public static void brandmessage(String message) {
        if (MinecraftClient.getInstance().player != null) {
            Text prefix = TextHelper.applyPredefinedGradient("Moonshine Client -> ", "black_light_purple", true);
    ...
    public static Text ircprefixMoonshine(String message) {
