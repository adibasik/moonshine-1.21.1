package moonshine.screens.menu;
...
import moonshine.screens.account.AccountEntry;
import moonshine.screens.account.AccountRenderer;
import moonshine.util.config.impl.account.AccountConfig;
...
public class MainMenuScreen extends Screen {
    ...
    private static final Identifier BACKGROUND_TEXTURE = Identifier.of("moonshine", "textures/menu/backmenu.png");
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        Fonts.TEST.drawCentered("Moonshine Client © All Rights Reserved", fixedWidth / 2f, fixedHeight - 6, 5f, new Color(128, 128, 128, 128).getRGB());
