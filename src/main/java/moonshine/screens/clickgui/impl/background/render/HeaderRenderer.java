...
public class HeaderRenderer {
    ...
    private void renderHeaderPanel(float bgX, float bgY, float bgWidth, float alphaMultiplier) {
        ...
        Render2D.rect(bgX + 92f, bgY + 7.5f, bgWidth - 100f, 25, moonshine.util.color.ClientColors.primary(panelAlpha), 8);
        Render2D.outline(bgX + 92f, bgY + 7.5f, bgWidth - 100f, 25, 0.5f, moonshine.util.color.ClientColors.primary(outlineAlpha), 8);
    }
